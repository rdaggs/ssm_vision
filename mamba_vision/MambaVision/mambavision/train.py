...
import shutil
from utils.datasets import imagenet_lmdb_dataset, get_loaders_search, get_loaders_eval, get_loaders
...
group.add_argument('--model', default='gcvit_tiny', type=str, metavar='MODEL',
                    help='Name of model to train (default: "gcvit_tiny"')
...
def main():
    ...
    if args.lmdb_dataset:
        ...
        loader_train, loader_eval, num_classes = get_loaders(args, mode = 'eval', dataset=args.dataset)
        dataset_train = loader_train.dataset
        dataset_eval = loader_eval.dataset
